...
function writePassword() {
  ...
  if ((lowercaseConfirm == true || uppercaseConfirm == true || specialCharConfirm == true) && passlength < 129 && passlength > 7 ){
    confirm(`You would like ${ passlength } character password. It is ${ lowercaseConfirm } that you want lower-case letters. It is ${ uppercaseConfirm } that you want upper-case letters. It is ${ specialCharConfirm } that you want special characters.`)
  }
  else {
